        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                   <a href="Application.html"><img class="d-block w-100" src="img/new apply.jpg" height="290" alt="First slide"></a> 
                  </div>
              <div class="carousel-item ">
                <img class="d-block w-100" src="img/unity_awards2020.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="img/svanidhi.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="img/iGot.jpg" alt="Fourth slide">
              </div>
            </div>
          </div>
        <div class="row">
            ...
            <div class="card card2 col-md-6" style="width: 27rem; ">
                <div class="card-body">
                    ...
                    <br>
                    <a href="Application.html" class="card-link"><h3>Apply now</h3></a>
